 ...
 */
@Component
 public class Coursee extends BaseResource {
	...
	private Date course_date = null;
	private String course_code = null;
	private Integer course_credits = null;
	...
	public static String FIELD_COURSE_DATE = "course_date";
	public static String FIELD_COURSE_CODE = "course_code";
	public static String FIELD_COURSE_CREDITS = "course_credits";
	public static String FIELD_STATUS = "status";
	public static String FIELD_DESCRIPTION = "description";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("coursee");
	...
	static {
		...
		Field course_dateField = new Field("course_date", "Date");
		course_dateField.setIndexed(true);
		metaData.addField(course_dateField);

		Field course_codeField = new Field("course_code", "String");
		course_codeField.setIndexed(true);
		metaData.addField(course_codeField);

		Field course_creditsField = new Field("course_credits", "Integer");
		metaData.addField(course_creditsField);
		...
		metaData.setTableName("coursee");

		metaData.setCluster("exam_portal");
	}

	public Coursee() {this.setId(Util.getUniqueId());}
	public Coursee(String id) {this.setId(id);}

	public Coursee(Coursee obj) {
		this.id = obj.id;
		...
		this.course_date = obj.course_date;
		this.course_code = obj.course_code;
		this.course_credits = obj.course_credits;
	...
	public Map<String, Object> convertResourceToMap(HashMap<String, Object> map) {
		...
		if(course_credits != null)
			map.put("course_credits", course_credits);
		if(status != null)
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		course_date = (Date) map.get("course_date");
		course_code = (String) map.get("course_code");
		course_credits = (Integer) map.get("course_credits");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object course_dateObj = map.get("course_date");
		if(course_dateObj != null)
			course_date = new Date(course_dateObj.toString());

		Object course_codeObj = map.get("course_code");
		if(course_codeObj != null)
			course_code = course_codeObj.toString();

		Object course_creditsObj = map.get("course_credits");
		if(course_creditsObj != null)
			course_credits = new Integer(course_creditsObj.toString());
	...
	public String getCourse_codeEx() {
		return course_code != null ? course_code : "";
	}
	...
	public void unSetCourse_credits() {
		this.course_credits = null;
	}
	...
	public  Class<?> getResultClass() {return CourseeResult.class;};
	public  Class<?> getMessageClass() {return CourseeMessage.class;};
	public  Class<?> getHelperClass() {return CourseeHelper.class;};
	public  Class<?> getServiceClass() {return CourseeService.class;};
}