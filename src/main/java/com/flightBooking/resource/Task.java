...
@Component
 public class Task extends BaseResource {
	...
	private String Comment_Section = null;
	...
	public static String FIELD_COMMENT_SECTION = "Comment_Section";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("task");
	...
	static {
		...
		Field TaskField = new Field("Task", "String");
		TaskField.setRequired(true);
		metaData.addField(TaskField);
		...
		PriorityField.setEnum(true);
		PriorityField.setPossible_value("Priority");
		...
		Field Comment_SectionField = new Field("Comment_Section", "String");
		metaData.addField(Comment_SectionField);
		...
		metaData.setTableName("task");

		metaData.setCluster("traveler_db");
	}

	public Task() {this.setId(Util.getUniqueId());}
	public Task(String id) {this.setId(id);}
	...
	public Task(Task obj) {
		...
		this.Comment_Section = obj.Comment_Section;
	...
	public Map<String, Object> convertResourceToMap(HashMap<String, Object> map) {
		...
		if(Comment_Section != null)
			map.put("Comment_Section", Comment_Section);
		if(extra_data != null)
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		Comment_Section = (String) map.get("Comment_Section");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object Comment_SectionObj = map.get("Comment_Section");
		if(Comment_SectionObj != null)
			Comment_Section = Comment_SectionObj.toString();
	...
	public boolean validateTask(boolean add) throws ApplicationException {
		if(add && Task == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[Task]");
		return Task != null;
	}
	...
	public String getComment_SectionEx() {
		return Comment_Section != null ? Comment_Section : "";
	}
	...
	public void unSetComment_Section() {
	...
	public  Class<?> getResultClass() {return TaskResult.class;};
	public  Class<?> getMessageClass() {return TaskMessage.class;};
	public  Class<?> getHelperClass() {return TaskHelper.class;};
	public  Class<?> getServiceClass() {return TaskService.class;};
}